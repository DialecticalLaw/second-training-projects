...
const carSvgText: string = `<svg fill="#000000" version="1.1" class="garage__car_icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
...
export function carCardCreator(options: Car): HTMLDivElement {
  ...
  const brakeBtn = createElem<HTMLButtonElement>('button', { class: 'garage__car_brake' });
  ...
  carIcon.style.fill = options.color;
  const flag = createElem<HTMLImageElement>('img', {
